...
let menuButton, game1Button, game2Button, game3Button, game4Button, game5Button;
...
function setup() {
  ...
  game5Button = createButton('Typing');
  game5Button.position(10, 250);
  game5Button.mousePressed(game5Setup);
  game5Button.show();
}
